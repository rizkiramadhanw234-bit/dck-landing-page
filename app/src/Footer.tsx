...
export default function Footer() {
    return (
        <>
            {/* FOOTER */}
            <footer className="bg-black py-8 sm:py-10 px-4 sm:px-6 text-center text-gray-500 text-xs border-t border-gray-800">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 sm:gap-10 md:gap-12 max-w-7xl mx-auto">
                    ...
                    <div className="text-left">
                        <div className="flex sm:flex-row items-center sm:items-start gap-3 mb-4">
                            <div className="w-7 h-7 bg-(--color2) rounded-full flex items-center justify-center font-bold text-white shrink-0">
                                DCK
                            </div>
                            <h2 className="text-sm sm:text-xl font-bold text-white text-center sm:text-left sm:mt-0">
                    ...
                    <div className="text-left">
                        ...
                        <ul className="space-y-2 sm:space-y-3 text-white text-sm sm:text-base">
                            ...
                            <li className="hover:text-gray-200 cursor-pointer">Case Studies</li>
                        </ul>
                    </div>

                    {/* CONTACT */}
                    <div className="text-left">
                        <h3 className="text-lg sm:text-xl font-semibold mb-3 sm:mb-4 text-white">Contact</h3>
                        <ul className="space-y-2 sm:space-y-3 text-white text-sm sm:text-base">
                ...
                {/* COPYRIGHT */}
                <div className="border-t border-gray-700 mt-8 sm:mt-10 md:mt-12 pt-4 sm:pt-6 text-center text-white text-xs sm:text-sm">
